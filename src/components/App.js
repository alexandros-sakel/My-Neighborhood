...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            'alllocations': [
                {
                    'name': "Aristotel University",
                    'type': "University",
                    'latitude': 40.6305606,
                    'longitude': 22.9597289,
                    'streetAddress': ""
                },
                {
                    'name': "Cocktail Bar",
                    'type': "Bar",
                    'latitude': 40.6377491,
                    'longitude': 22.9345867,
                    'streetAddress': "Politechniou 17"
                },
                {
                    'name': "Estrella",
                    'type': "Brunch",
                    'latitude': 40.632219,
                    'longitude': 22.947277,
                    'streetAddress': "P.Mela"
                },
                {
                    'name': "Ippokrateio General Hospital",
                    'type': "Hospital",
                    'latitude': 40.6122638,
                    'longitude': 22.9615187,
                    'streetAddress': "Konstantinoupoleos 49"
                },
                {
                    'name': "Makedonia Palace Hotel",
                    'type': "Hotel",
                    'latitude': 40.618236,
                    'longitude': 22.9530767,
                    'streetAddress': "Agia triada"
                },
                {
                    ...
                    'latitude': 40.6264393,
                    'longitude': 22.948538,
                    'streetAddress': "Leoforos Nikis"
                },
                {
                    'name': "Sushi Bar",
                    'type': "Asian Food",
                    'latitude': 40.6293033,
                    'longitude': 22.9451864,
                    'streetAddress': "Mitropolitou Iosif 3"
                },
                {
                    'name': "Brothers in Law",
                    'type': "Food",
                    'latitude': 40.6307782,
                    'longitude': 22.9475186,
                    'streetAddress': "P.Mela 30"
                },
                {
                    'name': "Kitchen Bar",
                    'type': "Bar with kitchen",
                    'latitude': 40.632133,
                    'longitude': 22.9355000,
                    'streetAddress': "Navarxou Votsi"
                },
                {
    ...
    initMap() {
        ...
        var map = new window.google.maps.Map(mapview, {
            center: {lat: 40.6294646, lng: 22.9414034},
            zoom: 15,
